...
public class FrontendAnalyticsDictionaryConfig {
    ...
    private void upsertMetricTypes(StageMetricTypeRepository repository) {
        List<MetricSeed> numeric = List.of(
            ...
            new MetricSeed("FRONTEND_DOM_INTERACTIVE_MS", "Готовность DOM к взаимодействию (DOM Interactive, мс)", "Время до DOM Interactive", SystemMetricReadingGuides.guideFor("FRONTEND_DOM_INTERACTIVE_MS"), MetricValueKind.NUMERIC, "ms"),
            new MetricSeed("FRONTEND_DOM_CONTENT_LOADED_MS", "DOM загружен (DOMContentLoaded, мс)", "Время до DOMContentLoaded", SystemMetricReadingGuides.guideFor("FRONTEND_DOM_CONTENT_LOADED_MS"), MetricValueKind.NUMERIC, "ms"),
            new MetricSeed("FRONTEND_LOAD_EVENT_MS", "Завершение загрузки страницы (Load Event, мс)", "Время до события load", SystemMetricReadingGuides.guideFor("FRONTEND_LOAD_EVENT_MS"), MetricValueKind.NUMERIC, "ms"),
            ...
            new MetricSeed("FRONTEND_LCP_MS", "Отрисовка самого крупного элемента (LCP, мс)", "Largest Contentful Paint", SystemMetricReadingGuides.guideFor("FRONTEND_LCP_MS"), MetricValueKind.NUMERIC, "ms"),
            new MetricSeed("FRONTEND_INP_MS", "Задержка отклика интерфейса (INP, мс)", "Interaction to Next Paint", SystemMetricReadingGuides.guideFor("FRONTEND_INP_MS"), MetricValueKind.NUMERIC, "ms"),
            ...
            new MetricSeed("FRONTEND_API_DURATION_MS", "Длительность API (мс)", "Длительность клиентского API-вызова", SystemMetricReadingGuides.guideFor("FRONTEND_API_DURATION_MS"), MetricValueKind.NUMERIC, "ms"),
            new MetricSeed("FRONTEND_RENDER_AFTER_API_MS", "Дорендер после API (мс)", "Длительность дорендера после ответа API", SystemMetricReadingGuides.guideFor("FRONTEND_RENDER_AFTER_API_MS"), MetricValueKind.NUMERIC, "ms"),
        ...
        List<MetricSeed> text = List.of(
            ...
            new MetricSeed("FRONTEND_TRACE_ID", "Идентификатор трассировки (Trace ID)", "Trace id, полученный клиентом из ответа backend", SystemMetricReadingGuides.guideFor("FRONTEND_TRACE_ID"), MetricValueKind.TEXT, null),
