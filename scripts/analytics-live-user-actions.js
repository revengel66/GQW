...
export const options = {
  scenarios: {
    shop_live_user_actions: {
      ...
      maxVUs: 90,
      stages: [
        { duration: "2m", target: BASE_ACTIONS_PER_MIN },
        { duration: "8m", target: BASE_ACTIONS_PER_MIN },
        { duration: "4m", target: Math.round(BASE_ACTIONS_PER_MIN * 1.35) },
        { duration: "4m", target: Math.round(BASE_ACTIONS_PER_MIN * 1.8) },
        { duration: "4m", target: Math.round(BASE_ACTIONS_PER_MIN * PEAK_MULTIPLIER) },
        { duration: "4m", target: Math.round(BASE_ACTIONS_PER_MIN * 1.55) },
        { duration: "6m", target: BASE_ACTIONS_PER_MIN },
